...
function showTitle0(){var vis=document.getElementById("vis");vis.setAttribute("style","display:none; ");var output=document.getElementById("output");output.setAttribute("style","display:none; ");var logoOpener=document.getElementById("logoOpener");logoOpener.setAttribute("style","display:inline-block; ");var openerimg=document.getElementById("openerimg");openerimg.setAttribute("style","visibility:visible; ");}
function showTitle1(){
...
output.setAttribute("style","display:fixed; ");}
function showTitle2(){
...
function showTitle5(){var vid2=document.getElementById("bgvid2");vid2.pause();}
function showTitle6(){var vid3=document.getElementById("bgvid3");vid3.pause();}
function showTitle7(){var vid3=document.getElementById("bgvid3");vid3.play();}
function showTitle8(){var vid3=document.getElementById("bgvid3");vid3.pause();}
function showTitle9(){}
